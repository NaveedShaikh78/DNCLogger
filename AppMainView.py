...
class AppMainView:
  def __init__(self):
    ...
    lb=Label(frame,  anchor=W, bg=rowcolor1 , padx = 0,  text=":")                 .grid(row=0,column=1,sticky=W+E+N+S)
    ...
    lb=Label(frame,  anchor=W, bg=rowcolor0 , padx = 0,  text=":")                 .grid(row=1,column=1,sticky=W+E+N+S)
    ...
    lb=Label(frame,  anchor=W, bg=rowcolor1 , padx = 0,  text=":")                 .grid(row=2,column=1,sticky=W+E+N+S)
    ...
    lb=Label(frame,  anchor=W, bg=rowcolor0 , padx = 0,  text=":")                 .grid(row=3,column=1,sticky=W+E+N+S)
    ...
    lb=Label(frame,  anchor=W, bg=rowcolor1 , padx = 0,  text=":")                 .grid(row=4,column=1,sticky=W+E+N+S)
